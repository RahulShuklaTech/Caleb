...
const SettingsBetaScreen = props => {
  ...
  return (
    <ScreenContainer scrollable={false} hasSafeArea={false}>
      <ScrollView
        style={styles.ScrollViewOT}
        contentContainerStyle={styles.ScrollViewOTContent}
                  ...
                  onPress={async () => {
                    try {
                      await WebBrowser.openBrowserAsync(
                        'https://forms.gle/9FWZe41LxScEhUFR9'
                      );
                    } catch (err) {
                      console.error(err);
                    }
