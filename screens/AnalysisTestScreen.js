...
import { ActivityIndicator, FlatList, Image, Modal, ScrollView, StyleSheet, Text, TextInput, View } from 'react-native';
...
const [textInputValue, setTextInputValue] = React.useState("");
      ...
      <ScrollView   contentContainerStyle={styles.ScrollViewajContent} showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false} bounces={true}>
     ...
     (newTextInputValue) => { const textInputValue = newTextInputValue;
  ...
  } style={[styles.TextInputjX, { backgroundColor: theme.colors.divider, color: theme.colors.background_inverse }]} placeholder={"Search teams..."} value={textInputValue} placeholderTextColor={theme.colors.light} clearButtonMode={"always"} autoCapitalize={"words"} autoFocus={true} />
      </View>
     }</>
      ...
      <Text  style={[styles.Text_9q, { color: theme.colors.background_inverse }]} >
        {"Spread"}
      </Text>
     ...
     () => { 
      ...
      <Text  style={[styles.Texta1, { color: theme.colors.divider }]} >
        {"Spread"}
      </Text>
      ...
      <Text  style={[styles.TextZq, { color: theme.colors.background_inverse }]} >
        {"Total"}
      </Text>
     ...
     () => { 
      ...
      <Text  style={[styles.Textnd, { color: theme.colors.divider }]} >
        {"Total"}
      </Text>
      ...
      <Text  style={[styles.Textaa, { color: theme.colors.background_inverse }]} >
        {"Moneyline"}
      </Text>
     ...
     () => { 
      ...
      <Text  style={[styles.Text_2j, { color: theme.colors.divider }]} >
        {"Moneyline"}
      </Text>
     ...
     () => { 
      ...
      <Text  style={[styles.TextwI, { color: theme.colors.divider }]} >
        {"Futures"}
      </Text>
...
<SwaggerAPIApi.FetchOddsDataGET
 ...
 >
  {({ loading, error, data, refetchOddsData }) => {
    ...
    return (<><Divider  style={styles.DividerH2} color={theme.colors.divider} />
      <View  style={styles.Viewow} pointerEvents={"auto"}>
        
      <Surface  style={{ backgroundColor: theme.colors.divider, borderRadius: 6 }} elevation={1}>
        <FlatList data={filterList(fetchData)} renderItem={({ item }) => { const listData = item; return (<>
      <Touchable   >
        
      <View  style={styles.ViewVN} pointerEvents={"auto"}>
        <>{ isLive(listData?.startTime) ? null : 
      <Text  style={[styles.Textb5, { color: theme.colors.light }]}  ellipsizeMode={"tail"} numberOfLines={1}>
        {dateTimeShort(listData?.startTime)}
      </Text>
     }</><>{ !(isLive(listData?.startTime)) ? null : 
      <Text  style={[styles.TextiZ, { color: theme.colors.good }]} >
        {"LIVE"}
      </Text>
     }</>
      <View  style={styles.Viewbw} pointerEvents={"auto"}>
        
      <Text  style={[styles.TextfX, { color: theme.colors.background_inverse }]}  ellipsizeMode={"tail"} numberOfLines={1}>
      ...
      <Text  style={[styles.TextJ0, { color: theme.colors.background_inverse }]} >
        {"@"}
      </Text>
      ...
      <Text  style={[styles.TextCc, { color: theme.colors.background_inverse }]}  ellipsizeMode={"tail"} numberOfLines={1}>
    ...
    <Divider  style={styles.DividerPb} color={theme.colors.background} /></>) }}  contentContainerStyle={styles.FlatListkYContent} numColumns={1} />
      </Surface>
      ...
      <View  style={[styles.ViewsJ, { backgroundColor: theme.colors.background }]} pointerEvents={"auto"}>
     ...
     () => { 
      ...
      <Text  style={[styles.TextmM, { color: theme.colors.background_inverse }]} >
        {"Leagues"}
      </Text>
    ...
    <View  style={[styles.Viewwa, { borderRadius: 0 }]}  />
      ...
      <View  style={styles.ViewLT} pointerEvents={"auto"}>
        <ButtonSolid  style={[styles.ButtonSolid_62, { backgroundColor: theme.colors.primary, color: theme.colors.strong }]} title={"Best Bets"}  icon={"Ionicons/ios-trophy"} /><ButtonSolid  style={[styles.ButtonSolidsl, { backgroundColor: theme.colors.background, color: theme.colors.background_inverse }]} title={"Best Bets"}  icon={"Ionicons/ios-trophy"} />
      </View>
    
      <View  style={styles.ViewCc} pointerEvents={"auto"}>
        <ButtonSolid  style={[styles.ButtonSolidj8, { backgroundColor: theme.colors.primary, color: theme.colors.strong }]} title={"Following"}  icon={"Ionicons/ios-flag"} /><ButtonSolid  style={[styles.ButtonSolidbd, { backgroundColor: theme.colors.background, color: theme.colors.background_inverse }]} title={"Following"}  icon={"Ionicons/ios-flag"} />
      </View>
    
      <View  style={styles.ViewmU} pointerEvents={"auto"}>
        <>{ !(oddsNFL(Constants["oddsDisplayed"])) ? null : <ButtonSolid  style={[styles.ButtonSolidju, { backgroundColor: theme.colors.primary, color: theme.colors.strong }]} title={"NFL"}  icon={"Ionicons/ios-american-football"} /> }</><>{ oddsNFL(Constants["oddsDisplayed"]) ? null : <ButtonSolid onPress={
     () => { 
      try {
          setGlobalVariableValue({
          key: "oddsDisplayed",
  ...
  } style={[styles.ButtonSolidK8, { backgroundColor: theme.colors.background, color: theme.colors.background_inverse }]} title={"NFL"}  icon={"Ionicons/ios-american-football"} /> }</>
      </View>
    
      <View  style={styles.ViewFz} pointerEvents={"auto"}>
        <>{ !(oddsNCAAF(Constants["oddsDisplayed"])) ? null : <ButtonSolid  style={[styles.ButtonSolidzb, { backgroundColor: theme.colors.primary, color: theme.colors.strong }]} title={"NCAAF"}  icon={"Ionicons/ios-american-football-outline"} /> }</><>{ oddsNCAAF(Constants["oddsDisplayed"]) ? null : <ButtonSolid onPress={
     () => { 
      try {
          setGlobalVariableValue({
          key: "oddsDisplayed",
  ...
  } style={[styles.ButtonSolidxT, { backgroundColor: theme.colors.background, color: theme.colors.background_inverse }]} title={"NCAAF"}  icon={"Ionicons/ios-american-football-outline"} /> }</>
      </View>
    
      <View  style={styles.View_5d} pointerEvents={"auto"}>
        <>{ !(oddsNBA(Constants["oddsDisplayed"])) ? null : <ButtonSolid  style={[styles.ButtonSolidIy, { backgroundColor: theme.colors.primary, color: theme.colors.strong }]} title={"NBA"}  icon={"Ionicons/ios-basketball"} /> }</><>{ oddsNBA(Constants["oddsDisplayed"]) ? null : <ButtonSolid onPress={
     () => { 
      try {
          setGlobalVariableValue({
          key: "oddsDisplayed",
  ...
  } style={[styles.ButtonSolidSO, { backgroundColor: theme.colors.background, color: theme.colors.background_inverse }]} title={"NBA"}  icon={"Ionicons/ios-basketball"} /> }</>
      </View>
    
      <View  style={styles.ViewcZ} pointerEvents={"auto"}>
        <>{ !(oddsNCAAB(Constants["oddsDisplayed"])) ? null : <ButtonSolid  style={[styles.ButtonSolidoI, { backgroundColor: theme.colors.primary, color: theme.colors.strong }]} title={"NCAAMB"}  icon={"Ionicons/ios-basketball-outline"} /> }</><>{ oddsNCAAB(Constants["oddsDisplayed"]) ? null : <ButtonSolid onPress={
     () => { 
      try {
          setGlobalVariableValue({
          key: "oddsDisplayed",
  ...
  } style={[styles.ButtonSolidqo, { backgroundColor: theme.colors.background, color: theme.colors.background_inverse }]} title={"NCAAMB"}  icon={"Ionicons/ios-basketball-outline"} /> }</>
      </View>
    
      <View  style={styles.View_4t} pointerEvents={"auto"}>
        <>{ !(oddsMLB(Constants["oddsDisplayed"])) ? null : <ButtonSolid  style={[styles.ButtonSolidFL, { backgroundColor: theme.colors.primary, color: theme.colors.strong }]} title={"MLB"}  icon={"Ionicons/ios-baseball"} /> }</><>{ oddsMLB(Constants["oddsDisplayed"]) ? null : <ButtonSolid onPress={
     () => { 
      try {
          setGlobalVariableValue({
          key: "oddsDisplayed",
  ...
  } style={[styles.ButtonSolidG7, { backgroundColor: theme.colors.background, color: theme.colors.background_inverse }]} title={"MLB"}  icon={"Ionicons/ios-baseball"} /> }</>
      </View>
    
      <View  style={styles.Viewk1} pointerEvents={"auto"}>
        <>{ !(oddsNHL(Constants["oddsDisplayed"])) ? null : <ButtonSolid  style={[styles.ButtonSolidBn, { backgroundColor: theme.colors.primary, color: theme.colors.strong }]} title={"NHL"}  icon={"MaterialCommunityIcons/hockey-sticks"} /> }</><>{ oddsNHL(Constants["oddsDisplayed"]) ? null : <ButtonSolid onPress={
     () => { 
      try {
          setGlobalVariableValue({
          key: "oddsDisplayed",
  ...
  } style={[styles.ButtonSolidwR, { backgroundColor: theme.colors.background, color: theme.colors.background_inverse }]} title={"NHL"}  icon={"MaterialCommunityIcons/hockey-sticks"} /> }</>
      </View>
    
      <View  style={styles.View_2w} pointerEvents={"auto"}>
        <>{ !(oddsMMA(Constants["oddsDisplayed"])) ? null : <ButtonSolid  style={[styles.ButtonSolid_62, { backgroundColor: theme.colors.primary, color: theme.colors.strong }]} title={"MMA"}  icon={"MaterialCommunityIcons/boxing-glove"} /> }</><>{ oddsMMA(Constants["oddsDisplayed"]) ? null : <ButtonSolid onPress={
     () => { 
      try {
          setGlobalVariableValue({
          key: "oddsDisplayed",
  ...
  } style={[styles.ButtonSolid_1G, { backgroundColor: theme.colors.background, color: theme.colors.background_inverse }]} title={"MMA"}  icon={"MaterialCommunityIcons/boxing-glove"} /> }</>
      </View>
...
const styles = StyleSheet.create({ IconXr: {
marginRight: 3,
}, TextSd: {
fontSize: 10,
}, IconbG: {
