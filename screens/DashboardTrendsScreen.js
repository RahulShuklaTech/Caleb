...
import { StatusBar, StyleSheet, Text, View } from 'react-native';
  ...
  StatusBar.setBarStyle('light-content');
      ...
      <Text  style={[styles.Textri, { color: theme.colors.background_inverse }]} >
      ...
      <View  style={[styles.ViewcF, { backgroundColor: theme.colors.divider, borderRadius: 6, borderColor: theme.colors.divider }]} collapsable={false}>
        
      <View  style={styles.Viewpa} >
        <Icon   size={32} name={"Ionicons/ios-checkmark-circle-sharp"} color={theme.colors.good} /><Icon   color={theme.colors.error} name={"Ionicons/ios-close-circle-sharp"} size={32} /><Icon   name={"Ionicons/ios-alert-circle"} size={32} color={theme.colors.fair} />
      </View>
      ...
      <Text  style={[styles.TexteI, { color: theme.colors.background_inverse }]} >
        {"Your Bets"}
      </Text>
      ...
      <View  style={[styles.View_4i, { backgroundColor: theme.colors.divider, borderRadius: 6, borderColor: theme.colors.divider }]} collapsable={false}>
      ...
      <Text  style={[styles.Texttj, { color: theme.colors.background_inverse }]}  ellipsizeMode={"tail"} numberOfLines={2}>
      ...
      <Text  style={[styles.Textmb, { color: theme.colors.light }]}  ellipsizeMode={"tail"} numberOfLines={2}>
      ...
      <Text  style={[styles.TextQx, { color: theme.colors.background_inverse }]}  ellipsizeMode={"tail"} numberOfLines={1}>
        {"$100"}
      </Text>
    
      <Text  style={[styles.TextPl, { color: theme.colors.light }]}  ellipsizeMode={"tail"} numberOfLines={1}>
        {"Risk"}
      </Text>
    
      <Text  style={[styles.TextCx, { color: theme.colors.error }]}  ellipsizeMode={"tail"} numberOfLines={1}>
        {"-$100"}
      </Text>
    
      <Text  style={[styles.Textt5, { color: theme.colors.good }]}  ellipsizeMode={"tail"} numberOfLines={1}>
        {"$100"}
      </Text>
    
      <Text  style={[styles.TextNL, { color: theme.colors.background_inverse }]}  ellipsizeMode={"tail"} numberOfLines={1}>
        {"$0"}
      </Text>
    
      <Text  style={[styles.Textqk, { color: theme.colors.fair }]}  ellipsizeMode={"tail"} numberOfLines={1}>
        {"-$50"}
      </Text>
      ...
      <View  style={[styles.Viewgt, { backgroundColor: theme.colors.divider, borderRadius: 6, borderColor: theme.colors.divider }]} collapsable={false}>
      ...
      <Text  style={[styles.Textxq, { color: theme.colors.background_inverse }]}  ellipsizeMode={"tail"} numberOfLines={2}>
        {"POR -7 (+130) (First Half) asdf;adsf ;kj dj k j djk dk l dk l dfk jl;dfas kjldsafkjl kjl asdfk ja kldf ask jl df jdfk j daak dfs"}
      </Text>
      ...
      <Text  style={[styles.TextSH, { color: theme.colors.light }]}  ellipsizeMode={"tail"} numberOfLines={2}>
        {"CLE +4.5 (-110) (First Half) asdfs dakjldsf  f fdjkdfak fds kl kk lfkjdsafkjldafs kl dfk d kl dfskj fkj fsa"}
      </Text>
      ...
      <Text  style={[styles.TextPW, { color: theme.colors.background_inverse }]}  ellipsizeMode={"tail"} numberOfLines={1}>
        {"$100"}
      </Text>
    
      <Text  style={[styles.Texte3, { color: theme.colors.light }]}  ellipsizeMode={"tail"} numberOfLines={1}>
        {"Risk"}
      </Text>
    
      <Text  style={[styles.Textob, { color: theme.colors.error }]}  ellipsizeMode={"tail"} numberOfLines={1}>
        {"-$100"}
      </Text>
    
      <Text  style={[styles.TextGM, { color: theme.colors.good }]}  ellipsizeMode={"tail"} numberOfLines={1}>
        {"$100"}
      </Text>
    
      <Text  style={[styles.TextGR, { color: theme.colors.background_inverse }]}  ellipsizeMode={"tail"} numberOfLines={1}>
        {"$0"}
      </Text>
    
      <Text  style={[styles.TextxQ, { color: theme.colors.fair }]}  ellipsizeMode={"tail"} numberOfLines={1}>
        {"-$50"}
      </Text>
...
const styles = StyleSheet.create({ Textri: {
