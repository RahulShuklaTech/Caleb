      ...
      <View style={styles.Viewpc} pointerEvents={'auto'}>
        ...
        >
          <View style={[styles.Viewff, { borderRadius: 0 }]}>
            <View style={styles.ViewMh} pointerEvents={'auto'}>
              <View style={[styles.ViewRi, { borderRadius: 0 }]} />
              <View style={styles.ViewZl} />
              <View style={[styles.ViewZf, { borderRadius: 0 }]} />
            </View>
          </View>
        </Surface>
        ...
        <View style={styles.Viewyc}>
          <View style={styles.ViewgZ}>
            <Text
              style={[styles.Textz4, { color: theme.colors.mediumInverse }]}
            >
              {'Choose a username.'}
            </Text>
            ...
            <View style={styles.ViewSu}>
              <KeyboardAvoidingView
                style={styles.KeyboardAvoidingViewa4}
                enabled={true}
                behavior={'padding'}
              >
                <TextField
