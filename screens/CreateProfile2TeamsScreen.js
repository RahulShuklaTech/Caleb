...
import { StatusBar, StyleSheet, Text, View } from 'react-native';
  ...
  StatusBar.setBarStyle('light-content');
    ...
    <View  style={styles.ViewbL}  /><View  style={[styles.ViewUf, { borderRadius: 0 }]}  />
      </View>
      ...
      <Text  style={[styles.TextRd, { color: theme.colors.background_inverse }]} >
  ...
  } style={[styles.ButtonOutlineoa, { color: theme.colors.background, backgroundColor: theme.colors.primary }]} title={"Next"}  />
      </View>
...
const styles = StyleSheet.create({ View_4P: {
