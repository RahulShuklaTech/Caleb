                      ...
                      <>
                        {!typeSingleCompare(fetchData?.type) ? null : (
                          <FlatList
                            ...
                            contentContainerStyle={styles.FlatList_3rContent}
                            numColumns={1}
                          />
                        )}
                      </>
                        ...
                        {!Constants['toggleMultilegBetInfo'] ? null : (
                          <View pointerEvents={'auto'}>
                            ...
                            <FlatList
                                        ...
                                        >
                                          <>
                                            {propositionTotal(
                                              ...
                                              >
                                                {spacingSuffix(
                                                  listData?.propDetails?.player
                                                )}
                                                {spacingSuffix(
                                                  listData?.propDetails?.team
                                                )}
                                                {propositionUncommonDisplay(
                                                  listData?.proposition
                                                )}
                                                ...
                                                {lineSuffix(listData?.line)}
                                                {propDetailsMetricSpecial(
                                                  listData?.propDetails
                                                    ?.metricSpecial
                                                )}
                                                {oddsAmericanSyntax(
                                                ...
                                                {futureBetExists(
                                                  listData?.propDetails?.future
                                                )}
                                                {liveBetExists(listData?.live)}
                                              </Text>
                                            )}
                                          </>
                                          <>
                              ...
                              contentContainerStyle={styles.FlatListOtContent}
                              numColumns={1}
                            />
                          </View>
                        )}
