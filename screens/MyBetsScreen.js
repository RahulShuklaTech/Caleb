...
const MyBetsScreen = props => {
  ...
  const propDetailsMetricSpecialWorkaround = x => {
    return x == null || x.metricSpecial == null
      ? ''
      : x.metricSpecial.charAt(0).toUpperCase() +
          x.metricSpecial.slice(1) +
          ' ';
  };
...
*/
  ...
  const propDetailsTeamWorkaround = x => {
    return x == null || x.team == null ? '' : x.team + ' ';
  };
  ...
  const propDetailsPlayerWorkaround = x => {
    return x == null || x.player == null ? '' : x.player + ' ';
  };
  ...
  const futureBetExistsWorkaround = x => {
    return x == null || x.future == false ? '' : '(Future) ';
  };
...
return leaguesFilterTable[x[0]] || x; */
  ...
  return (
    <ScreenContainer hasSafeArea={false} hasTopSafeArea={true}>
      ...
      >
        <View style={[styles.Viewk0, { borderRadius: 0 }]}>
          <View style={styles.ViewXe} pointerEvents={'auto'}>
              ...
              >
                <View style={styles.ViewL9}>
                  ...
                  <>
                    {!countFiltersApplied() ? null : (
                      <Text
                        style={[styles.TextOF, { color: theme.colors.primary }]}
                      >
                        {countFiltersApplied()}
                      </Text>
                    )}
            ...
            <View style={[styles.Viewjg, { borderRadius: 0 }]}></View>
          </View>
        </View>
      </Surface>
      <>
        {!Constants['waitlisted'] ? null : (
          <View style={styles.ViewTD} pointerEvents={'auto'}>
            <View
              style={[styles.Viewyt, { backgroundColor: theme.colors.primary }]}
              pointerEvents={'auto'}
            >
              <View style={styles.ViewGX} pointerEvents={'auto'}>
            ...
            <ScrollView
              ...
              bounces={true}
            >
              <View style={styles.VieweL} pointerEvents={'auto'}>
                <Image
                  style={styles.ImageDi}
                  source={Images.MyBetsDemo}
                  resizeMode={'contain'}
                />
              </View>
            </ScrollView>
            ...
            <>
              {sportsbooksSynced ? null : (
                <View style={styles.ViewXj} pointerEvents={'auto'}>
                    ...
                    >
                      ...
                      >
                        <Icon
                          ...
                          color={theme.colors.strong}
                        />
                        <View style={styles.View_4o} pointerEvents={'auto'}>
                          <Text
                            style={[
                              styles.TextGt,
                              { color: theme.colors.strong },
                  ...
                  <ScrollView
                    contentContainerStyle={styles.ScrollViewukContent}
                    showsVerticalScrollIndicator={true}
                    bounces={true}
                  >
                    <View style={styles.Viewb6} pointerEvents={'auto'}>
                      <Image
      ...
      <ScrollView showsVerticalScrollIndicator={true} bounces={true}>
        <View style={styles.ViewBU} pointerEvents={'auto'}>
          <>
            {!betStatusHistorical(Constants['filterBetStatusApply']) ? null : (
              <View style={styles.Viewrz} pointerEvents={'auto'}>
                <Text
                  style={[
                    styles.Text_0B,
        ...
        >
          {({
            ...
            return (
              <>
                <View style={styles.ViewTg} pointerEvents={'auto'}>
                  <>
                    {betsFound ? null : (
                      <View style={styles.ViewSS} pointerEvents={'auto'}>
                        <Text
                          style={[styles.TextOm, { color: theme.colors.light }]}
                        >
                          {'No Bets Found'}
                        </Text>
                      </View>
                  ...
                  <FlatList
                    ...
                    renderItem={({ item }) => {
                      const allBetsListData = item;
                      return (
                        <>
                          <>
                            {!betStatusHistorical(
                              Constants['filterBetStatusApply']
                            ) ? null : (
                              <Touchable
                                onPress={() => {
                                  try {
                                    navigation.navigate('MyBetsBetInfoScreen', {
                                      Bet: allBetsListData?.id,
                                    });
                                  } catch (err) {
                                    console.error(err);
                                  }
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <View style={styles.Viewiy}>
                                        <>
                                          {!typeSingleCompare(
                                            allBetsListData?.type
                                          ) ? null : (
                                            <FlatList
                                              data={allBetsListData?.bets}
                                              renderItem={({ item }) => {
                                        ...
                                        <>
                                          {!typeSingleCompare(
                                            ...
                                            <FlatList
                                              data={allBetsListData?.bets}
                                              renderItem={({ item }) => {
                                                const gradedMultiSingleBetLowerLevelData =
                                                  item;
                                                return (
                                                  <>
                                                    <>
                                                      {eventNotExist(
                                                        gradedMultiSingleBetLowerLevelData?.event
                                                      ) ? null : (
                                                        <Text
                                                          style={[
                                                            styles.TextBe,
                                                        ...
                                                        >
                                                          {eventLeagueSuffix(
                                                            gradedMultiSingleBetLowerLevelData
                                                              ?.event?.league
                                                          )}
                                                          {
                                                            gradedMultiSingleBetLowerLevelData
                                        ...
                                        <>
                                          {!typeSingleCompare(
                                            ...
                                            <FlatList
                                              data={allBetsListData?.bets}
                                              renderItem={({ item }) => {
                                                const pendingMultiSingleBetLowerLevelData =
                                                  item;
                                                return (
                                                  <>
                                                    <>
                                                      {eventNotExist(
                                                        pendingMultiSingleBetLowerLevelData?.event
                                                      ) ? null : (
                                                        <Text
                                                          style={[
                                                            styles.TextEe,
                                                        ...
                                                        >
                                                          {eventLeagueSuffix(
                                                            pendingMultiSingleBetLowerLevelData
                                                              ?.event?.league
                                                          )}
                                                          {
                                                            pendingMultiSingleBetLowerLevelData
                    ...
                    contentContainerStyle={styles.FlatList_6zContent}
                    numColumns={1}
                  />
      ...
      >
        <View
          style={[styles.ViewbX, { backgroundColor: theme.colors.background }]}
          pointerEvents={'auto'}
        >
          <Surface
            style={[
            ...
            elevation={2}
          >
            <View style={styles.Viewza} pointerEvents={'auto'}>
              <View style={[styles.View_8o, { borderRadius: 0 }]}>
                ...
                <>
                  {!loadingCancel ? null : (
                    <ActivityIndicator
                      style={styles.ActivityIndicatorDT}
                      size={'small'}
                      animating={true}
              ...
              <View style={[styles.ViewZI, { borderRadius: 0 }]}>
                ...
                <>
                  {!loadingReset ? null : (
                    <ActivityIndicator
                      style={styles.ActivityIndicatoruw}
                      size={'small'}
                      animating={true}
                      hidesWhenStopped={true}
                      color={theme.colors.primary}
          ...
          <ScrollView
            contentContainerStyle={styles.ScrollViewICContent}
          ...
          >
            <View style={styles.Viewmr} pointerEvents={'auto'}>
              ...
              <View style={styles.View_04} pointerEvents={'auto'}>
                <SwaggerAPIApi.FetchGetBankrollPageByIdGET
                  dummy={Constants['updatedSportsBook']}
                  internalId={Constants['internalId']}
                >
                  {({ loading, error, data, refetchGetBankrollPageById }) => {
                    ...
                    return (
                      <FlatList
                        ...
                        contentContainerStyle={styles.FlatList_3LContent}
                        numColumns={1}
                      />
                    );
                  }}
            ...
            <View style={styles.ViewBL} pointerEvents={'auto'}>
              <Text
                style={[
                  styles.TextZN,
                  { color: theme.colors.background_inverse },
              ...
              {Constants['toggleAdvancedFilters'] ? null : (
                <View pointerEvents={'auto'}>
                  <View style={styles.VieweS} pointerEvents={'auto'}>
                    ...
                    >
                      <View style={styles.Viewjo} pointerEvents={'auto'}>
                        <Text
                          style={[
                            styles.Textjp,
                            { color: theme.colors.background_inverse },
            ...
            <>
              {!Constants['toggleAdvancedFilters'] ? null : (
                <View pointerEvents={'auto'}>
                  <View style={styles.View_1s} pointerEvents={'auto'}>
                    <Touchable
                      onPress={() => {
                        try {
                          setGlobalVariableValue({
                  ...
                  <View style={styles.ViewgU} pointerEvents={'auto'}>
                    ...
                    <Divider
                      style={styles.Dividervu}
                      color={theme.colors.divider}
                    />
                  </View>

                  <View style={styles.View_8q} pointerEvents={'auto'}>
                    <Text
                      style={[
                        styles.TextXM,
                        { color: theme.colors.background_inverse },
            ...
            >
              ...
              >
                <View
                  style={[
                    styles.ViewIM,
                    { borderRadius: 6, backgroundColor: theme.colors.good },
                  ]}
                  pointerEvents={'auto'}
                >
                  <>
                  ...
                  <>
                    {!loadingApply ? null : (
                      <ActivityIndicator
                        style={styles.ActivityIndicatorWg}
                        size={'small'}
                        animating={true}
                        hidesWhenStopped={true}
                      />
