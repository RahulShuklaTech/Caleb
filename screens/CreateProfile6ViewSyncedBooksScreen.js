      ...
      <View pointerEvents={'auto'}>
        <View style={[styles.View_4k, { borderRadius: 0 }]}>
          <View style={styles.ViewwO} pointerEvents={'auto'}>
            ...
            <View style={[styles.Viewg8, { borderRadius: 0 }]} />
          </View>
        </View>
            ...
            return (
              <>
                ...
                <FlatList
                    ...
                    return (
                      <View style={styles.ViewWF} pointerEvents={'auto'}>
                        <View style={styles.Viewt2} pointerEvents={'auto'}>
                          ...
                          <>
                            {!bookStatus(
                              listData?.latestRefreshResponse?.status
                            ) ? null : (
                              <View pointerEvents={'auto'}>
                                <Touchable
                                  onPress={() => {
                  ...
                  contentContainerStyle={styles.FlatListICContent}
                  numColumns={1}
                />
                <>
                  {booksSynced(fetchData) ? null : (
                    <View style={styles.ViewrQ} pointerEvents={'auto'}>
                      <Text
                        style={[styles.TextuU, { color: theme.colors.light }]}
                      >
                        {
      ...
      <View pointerEvents={'auto'}>
        ...
        >
          {({ loading, error, data, refetchGetAllBettorAccountsKate$s }) => {
            ...
            return (
              <View
                style={[styles.View_1B, { borderColor: theme.colors.divider }]}
              >
