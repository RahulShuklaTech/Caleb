...
import { StyleSheet, Text, View } from 'react-native';
    ...
    const DashboardOverallStatsHelpScreen = props => {
      ...
      <Text  style={[styles.TextJk, { color: theme.colors.background_inverse }]} >
        {"Record"}
      </Text>
      ...
      <Text  style={[styles.Textir, { color: theme.colors.background_inverse }]} >
      ...
      <Text  style={[styles.TextDr, { color: theme.colors.background_inverse }]} >
        {"Net Profit"}
      </Text>
      ...
      <Text  style={[styles.TexteP, { color: theme.colors.background_inverse }]} >
      ...
      <Text  style={[styles.TextO7, { color: theme.colors.background_inverse }]} >
...
const styles = StyleSheet.create({ TextJk: {
