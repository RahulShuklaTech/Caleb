    ...
    >
      ...
      >
        <View style={[styles.ViewjO, { borderRadius: 0 }]}>
          <View style={styles.ViewMM} pointerEvents={'auto'}>
                ...
                <>
                  {!oddsNFL(Constants['oddsDisplayed']) ? null : (
                    <View style={styles.View_03}>
                      <Icon
                        style={styles.IconGo}
                        name={'Ionicons/ios-american-football'}
                        color={theme.colors.light}
                        size={28}
                      />
                      <Text
                        style={[styles.Textut, { color: theme.colors.light }]}
                      >
                        {'NFL'}
                      </Text>
                    </View>
                  ...
                  {!oddsNCAAF(Constants['oddsDisplayed']) ? null : (
                    <View style={styles.View_7s}>
                      <Icon
                        ...
                        name={'Ionicons/ios-american-football-outline'}
                        color={theme.colors.light}
                        size={28}
                      />
                      <Text
                        style={[styles.Texta6, { color: theme.colors.light }]}
                      >
                        {'NCAAF'}
                      </Text>
                    </View>
                ...
                <>
                  {!oddsNBA(Constants['oddsDisplayed']) ? null : (
                    <View style={styles.ViewV3}>
                      <Icon
                        style={styles.IconYU}
                        name={'Ionicons/ios-basketball'}
                        color={theme.colors.light}
                        size={28}
                      />
                      <Text
                        style={[styles.Textza, { color: theme.colors.light }]}
                      >
                        {'NBA'}
                      </Text>
                    </View>
                ...
                <>
                  {!oddsNCAAB(Constants['oddsDisplayed']) ? null : (
                    <View style={styles.ViewH3}>
                      <Icon
                        style={styles.Iconoe}
                        name={'Ionicons/ios-basketball-outline'}
                        color={theme.colors.light}
                        size={28}
                      />
                      <Text
                        style={[styles.Text_4b, { color: theme.colors.light }]}
                      >
                        {'NCAAMB'}
                      </Text>
                    </View>
                ...
                <>
                  {!oddsMLB(Constants['oddsDisplayed']) ? null : (
                    <View style={styles.ViewUz}>
                      <Icon
                        style={styles.IconM5}
                        name={'Ionicons/ios-baseball'}
                        color={theme.colors.light}
                        size={28}
                      />
                      <Text
                        style={[styles.TextZT, { color: theme.colors.light }]}
                      >
                        {'MLB'}
                      </Text>
                    </View>
                ...
                <>
                  {!oddsNHL(Constants['oddsDisplayed']) ? null : (
                    <View style={styles.View_7I}>
                      <Icon
                        style={styles.Icondo}
                        name={'MaterialCommunityIcons/hockey-sticks'}
                        color={theme.colors.light}
                        size={28}
                      />
                      <Text
                        style={[styles.Text_3J, { color: theme.colors.light }]}
                      >
                        {'NHL'}
                      </Text>
                    </View>
                ...
                <>
                  {!oddsMMA(Constants['oddsDisplayed']) ? null : (
                    <View style={styles.ViewyT}>
                      <Icon
                        style={styles.IconNE}
                        name={'MaterialCommunityIcons/boxing-glove'}
                        color={theme.colors.light}
                        size={28}
                      />
                      <Text
                        style={[styles.TextEn, { color: theme.colors.light }]}
                      >
                        {'MMA'}
                      </Text>
                    </View>
            ...
            <View style={[styles.View_5F, { borderRadius: 0 }]}>
              ...
              <>
                {!Constants['toggleGamesSearchBar'] ? null : (
                  ...
                  >
                    <View style={styles.ViewBK} pointerEvents={'auto'}>
                      <Icon
      ...
      <ScrollView
        contentContainerStyle={styles.ScrollViewINContent}
      ...
      >
        <View style={styles.ViewFZ} pointerEvents={'auto'}>
          ...
          >
            <View style={styles.View_7r} pointerEvents={'auto'}>
              <Image
                style={styles.Imageol}
                source={Images.UntitledDesign7}
                resizeMode={'contain'}
              />
            </View>
          </Touchable>
          ...
          <View style={styles.Viewum} pointerEvents={'auto'}>
            ...
            <>
              {oddsSpread(Constants['oddsDisplayed']) ? null : (
                ...
                >
                  <Text
                    style={[styles.TextJx, { color: theme.colors.divider }]}
                  >
                    {'Spread'}
                  </Text>
                </Touchable>
            ...
            <>
              {!oddsTotal(Constants['oddsDisplayed']) ? null : (
                <View style={styles.Viewev} pointerEvents={'auto'}>
                  <Text
                    style={[
                      styles.Text_7Q,
                      { color: theme.colors.background_inverse },
            ...
            <>
              {oddsTotal(Constants['oddsDisplayed']) ? null : (
                ...
                >
                  <Text
                    style={[styles.Text_6v, { color: theme.colors.divider }]}
                  >
                    {'Total'}
                  </Text>
                </Touchable>
            ...
            <>
              {oddsMoneyline(Constants['oddsDisplayed']) ? null : (
                ...
                >
                  <Text
                    style={[styles.Text_5A, { color: theme.colors.divider }]}
                  >
                    {'Moneyline'}
                  </Text>
                </Touchable>
                        ...
                        renderItem={({ item }) => {
                          ...
                          return (
                            <>
                              ...
                              <Divider
                                style={styles.DividerFP}
                                color={theme.colors.background}
                              />
                            </>
                          );
                        }}
                        contentContainerStyle={styles.FlatList_6YContent}
                        numColumns={1}
                      />
                    </Surface>
                    ...
                    >
                      <Utils.CustomCodeErrorBoundary>
                        <CustomCode.GamesScrollList
                          ...
                          selectedTeamLine={selectedTeamLine}
                          setSelectedTeamLine={setSelectedTeamLine}
                          selectedTeamOddsAmerican={selectedTeamOddsAmerican}
                          setSelectedTeamOddsAmerican={
                            setSelectedTeamOddsAmerican
                          }
                          selectedSportsbook={selectedSportsbook}
                          setSelectedSportsbook={setSelectedSportsbook}
                          selectedSportsbookUrl={selectedSportsbookUrl}
                          setSelectedSportsbookUrl={setSelectedSportsbookUrl}
                        ></CustomCode.GamesScrollList>
                      </Utils.CustomCodeErrorBoundary>
                    </ScrollView>
                  </View>
                  ...
                  >
                    ...
                    >
                      <View pointerEvents={'auto'}>
                        <View
                          style={[styles.View_9r, { borderRadius: 10 }]}
                          pointerEvents={'auto'}
                        >
                          ...
                          <View style={[styles.ViewlS, { borderRadius: 0 }]}>
                            ...
                            >
                              ...
                              <>
                                {!compareFanDuel(selectedSportsbook) ? null : (
                                  <Image
                                    style={styles.Imageh2}
                                    resizeMode={'contain'}
                              ...
                              <>
                                {!compareBarstool(selectedSportsbook) ? null : (
                                  <Image
                                    style={styles.ImageP9}
                              ...
                              <>
                                {!compareCaesars(selectedSportsbook) ? null : (
                                  <Image
                        ...
                        <View style={styles.ViewpU} pointerEvents={'auto'}>
                          <>
                  ...
                  >
                    ...
                    >
                      <Surface
                        ...
                        elevation={2}
                      >
                        <View style={styles.View_06} pointerEvents={'auto'}>
                      ...
                      <View style={styles.Viewkc} pointerEvents={'auto'}>
                        <View style={styles.ViewRG} pointerEvents={'auto'}>
                          <View style={styles.Viewxh} pointerEvents={'auto'}>
                            <>
                              {!oddsNFL(Constants['oddsDisplayed']) ? null : (
                                <ButtonSolid
                                  style={[
                                    styles.ButtonSolidJj,
                                    {
                                      backgroundColor: theme.colors.primary,
                                      color: theme.colors.strong,
                                    },
                          ...
                          <View style={styles.ViewEe} pointerEvents={'auto'}>
                            <>
                              {!oddsNCAAF(Constants['oddsDisplayed']) ? null : (
                                <ButtonSolid
                                  style={[
                                    styles.ButtonSolidIC,
                                    {
                                      backgroundColor: theme.colors.primary,
                                      color: theme.colors.strong,
                                    },
                          ...
                          <View style={styles.ViewM9} pointerEvents={'auto'}>
                            <>
                              {!oddsMLB(Constants['oddsDisplayed']) ? null : (
                                <ButtonSolid
                                  style={[
