...
import { StatusBar, StyleSheet, Text, View } from 'react-native';
  ...
  StatusBar.setBarStyle('light-content');
      ...
      <Text  style={[styles.TextmQ, { color: theme.colors.background_inverse }]} >
        {"Net Profit"}
      </Text>
      ...
      <Text  style={[styles.TextAP, { color: theme.colors.background_inverse }]} >
...
const styles = StyleSheet.create({ TextmQ: {
