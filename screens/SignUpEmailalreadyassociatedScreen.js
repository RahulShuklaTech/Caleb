...
import { StyleSheet, Text, View } from 'react-native';
    ...
    const SignUpEmailalreadyassociatedScreen = props => {
...
return (
  <Provider>
   ...
   <Button
    ...
    >
      ...
      <View  style={[styles.ViewMm, { borderRadius: 0 }]} >
        
      <View  style={styles.ViewJd} pointerEvents={"auto"}>
        
      <View  style={[styles.ViewSX, { borderRadius: 0 }]} >
    ...
    <View  style={styles.Viewmt}  /><View  style={[styles.ViewbJ, { borderRadius: 0 }]}  />
      </View>
  ...
  } style={[styles.ButtonOutlinec7, { color: theme.colors.strong, backgroundColor: theme.colors.primary }]} title={"Log In"}  />
      </View>
...
const styles = StyleSheet.create({ ViewTo: {
justifyContent: 'center',
...
export default withTheme(SignUpEmailalreadyassociatedScreen);