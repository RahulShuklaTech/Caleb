            ...
            <View style={[styles.Viewuh, { borderRadius: 0 }]}>
              <Touchable>
                <View style={styles.Viewtb}>
                  <Icon
                    style={styles.IconNW}
                    name={'Ionicons/ios-analytics-sharp'}
                  ...
                  />
                  <Text
                    style={[styles.TextX0, { color: theme.colors.background }]}
                  >
                    {'10'}
                  </Text>
                </View>
            ...
            <View>
              <View>
                ...
                <View style={styles.ViewVY} pointerEvents={'auto'}>
                  <ScrollView
                    contentContainerStyle={styles.ScrollView_4vContent}
                ...
                <SwaggerAPIApi.FetchGetBetslipsByBettorIdNotKate$sGET>
                  {({
                    ...
                    return (
                      <>
                        <FlatList
                          data={pendingArrayWorkaround(fetchPendingData)}
                          renderItem={({ item }) => {
                            const listPendingData = item;
                            return (
                              <View
                                style={styles.ViewpD}
                                pointerEvents={'auto'}
                                    ...
                                    >
                                      <View style={styles.ViewMV}>
                                        ...
                                        <View style={styles.ViewOo}>
                                          <>
                                            {!typeSingleCompare(
                                              listPendingData?.type
                                            ) ? null : (
                                              <FlatList
                                                data={listPendingData?.bets}
                                                renderItem={({ item }) => {
                        ...
                        />
                        <>
                          {!pendingBetsFound(fetchPendingData) ? null : (
                            <Text
                              style={[
                                styles.TextZG,
                                { color: theme.colors.light },
            ...
            <SwaggerAPIApi.FetchGetBetslipsByBettorIdNotKate$sGET>
              {({
                ...
                return (
                  <>
                    <FlatList
                      data={fetchGradedData}
                      renderItem={({ item }) => {
                        const listGradedData = item;
                        return (
                          <>
                            <>
                              {!notPendingOutcomeCompare(
                                listGradedData?.outcome
                              ) ? null : (
                                <View
                                  style={styles.ViewbQ}
                                  pointerEvents={'auto'}
                      ...
                      contentContainerStyle={styles.FlatListbuContent}
                      numColumns={1}
                    />
                    <>
                      {!gradedBetsFound(fetchGradedData) ? null : (
                        <Text
                          style={[styles.Textp4, { color: theme.colors.light }]}
                        >
