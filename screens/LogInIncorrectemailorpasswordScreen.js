...
return (
  <Provider>
   ...
   <Button
    ...
    <View  style={styles.Viewfs}  /><View  style={[styles.ViewR2, { borderRadius: 0 }]}  />
      </View>
      ...
      <Text  style={[styles.TextCU, { color: theme.colors.background_inverse }]} >
  ...
  } style={[styles.ButtonOutlinevE, { color: theme.colors.strong, backgroundColor: theme.colors.primary }]} title={"Try again"}  />
      </View>
...
const styles = StyleSheet.create({ ViewZ5: {
justifyContent: 'center',
