    ...
    >
      ...
      >
        <View style={[styles.View_0m, { borderRadius: 0 }]}>
          <View style={styles.Viewke} pointerEvents={'auto'}>
            ...
            <View style={[styles.ViewxS, { borderRadius: 0 }]} />
          </View>
        </View>
      </Surface>
      ...
      <View style={styles.ViewH0} pointerEvents={'auto'}>
        <View style={styles.ViewLb}>
          <Text
            style={[styles.Text_2I, { color: theme.colors.background_inverse }]}
          >
            {'Reset password.'}
          </Text>

          <KeyboardAvoidingView
            style={styles.KeyboardAvoidingViewjF}
            enabled={true}
            behavior={'padding'}
          >
            <TextField
