...
import { StatusBar, StyleSheet, Text, View } from 'react-native';
  ...
  StatusBar.setBarStyle('light-content');
      ...
      <Text  style={[styles.Text_9f, { color: theme.colors.background_inverse }]} >
        {"{League}s"}
      </Text>
      ...
      <View  style={[styles.View_78, { borderRadius: 6, backgroundColor: theme.colors.divider, borderColor: theme.colors.divider }]} >
        
      <View  style={styles.ViewlT} pointerEvents={"auto"}>
        
      <Text  style={[styles.TextR6, { color: theme.colors.background_inverse }]} >
        {"NCAAB"}
      </Text>
...
const styles = StyleSheet.create({ Text_9f: {
