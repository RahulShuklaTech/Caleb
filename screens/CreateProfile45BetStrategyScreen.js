...
import { ButtonOutline, Icon, RadioButtonGroup, RadioButtonRow, ScreenContainer, Surface, Touchable, withTheme } from '@draftbit/ui';
import { StyleSheet, Text, View } from 'react-native';
    ...
    const CreateProfile45BetStrategyScreen = props => {
      ...
      const [radioButtonGroupBetStrategy, setRadioButtonGroupBetStrategy] = React.useState(undefined);
    ...
    <View  style={styles.ViewCb}  /><View  style={[styles.ViewHH, { borderRadius: 0 }]}  />
      </View>
      ...
      <RadioButtonGroup onValueChange={
     (newRadioButtonGroupValue) => { const radioButtonGroupBetStrategy = newRadioButtonGroupValue;
      try {
  ...
  } style={styles.RadioButtonGroupEw} value={radioButtonGroupBetStrategy} direction={"vertical"}>
        <RadioButtonRow  style={[styles.RadioButtonRowBI, { color: theme.colors.background_inverse }]} label={"Flat bet (most common)"} color={theme.colors.primary} unselectedColor={theme.colors.primary} />
      <Text  style={[styles.TextEu, { color: theme.colors.light }]} >
        {"I generally bet one unit."}
      </Text>
    <RadioButtonRow  style={[styles.RadioButtonRow_1H, { color: theme.colors.background_inverse }]} label={"Confidence"} color={theme.colors.primary} unselectedColor={theme.colors.primary} />
      <Text  style={[styles.TextZA, { color: theme.colors.light }]} >
        {"I generally change my bet amount based on how confident I am."}
      </Text>
    <RadioButtonRow  style={[styles.RadioButtonRowUE, { color: theme.colors.background_inverse }]} label={"Percentage"} color={theme.colors.primary} unselectedColor={theme.colors.primary} />
      <Text  style={[styles.Textxf, { color: theme.colors.light }]} >
        {"I generally bet a set percentage of my bankroll."}
      </Text>
    <RadioButtonRow  style={[styles.RadioButtonRow_2M, { color: theme.colors.background_inverse }]} label={"Kelly Criterion"} color={theme.colors.primary} unselectedColor={theme.colors.primary} />
  ...
  } style={[styles.ButtonOutlinecU, { color: theme.colors.strong, backgroundColor: theme.colors.primary }]} title={"Next"}  />
      </View>
...
const styles = StyleSheet.create({ ViewVP: {
