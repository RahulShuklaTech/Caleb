    ...
    <ScreenContainer scrollable={true} hasSafeArea={true}>
      <View style={[styles.ViewDT, { borderRadius: 0 }]}>
        <View style={styles.ViewVZ} pointerEvents={'auto'}>
          ...
          <View style={[styles.Viewcb, { borderRadius: 0 }]} />
        </View>
      </View>

      <View style={styles.Viewaz}>
        <Text
          style={[styles.Text_00, { color: theme.colors.background_inverse }]}
        >
          {'Sign Up'}
        </Text>
        ...
        <View pointerEvents={'auto'}>
          <>
            {!verifySignUp(Constants['debugVar']) ? null : (
              <Text
                style={[styles.Textoa, { color: theme.colors.error }]}
                numberOfLines={50}
              >
                {Constants['debugVar']}
              </Text>
        ...
        >
          <TextField
            onChangeText={newTextFieldUnderlineValue => {
              const textFirstName = newTextFieldUnderlineValue;
              try {
          ...
          <TextField
            onChangeText={newTextFieldUnderlineValue => {
              const textUsername = newTextFieldUnderlineValue;
              try {
          ...
          <TextField
            onChangeText={newTextFieldUnderlineValue => {
              const textEmail = newTextFieldUnderlineValue;
              try {
          ...
          <TextField
            onChangeText={newTextFieldUnderlineValue => {
              const textPassword = newTextFieldUnderlineValue;
              try {
      ...
      <View style={styles.ViewjE}>
          ...
          <View style={styles.ViewDC} pointerEvents={'auto'}>
            <Checkbox
              onPress={newCheckboxValue => {
                const checkboxTermsPrivacy = newCheckboxValue;
                try {
              ...
              style={styles.CheckboxG8}
              status={checkboxTermsPrivacy}
            ...
            <ButtonOutline
              onPress={async () => {
                try {
                  ...
                  const signUpResult = await SwaggerAPIApi.signUpPOST(
                    Constants,
                    {
                      email: textEmail,
        ...
        <View style={styles.ViewW7}>
          <Touchable
            onPress={() => {
              try {
                navigation.navigate('Welcome_Stack', { screen: 'LogInScreen' });
              } catch (err) {
                console.error(err);
              }
            }}
