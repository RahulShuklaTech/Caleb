...
const MyBetsSaveFilterScreen = props => {
  ...
  const [savedFilterDescription, setSavedFilterDescription] =
    React.useState('');
    ...
    <ScreenContainer scrollable={true} hasSafeArea={false}>
      <View>
        <View>
          ...
          <KeyboardAvoidingView
            style={styles.KeyboardAvoidingViewqa}
            enabled={true}
            behavior={'padding'}
          >
            <View style={styles.ViewNn} pointerEvents={'auto'}>
              <TextField
                onChangeText={newTextFieldUnderlineValue => {
                  const savedFilterName = newTextFieldUnderlineValue;
                  try {
            ...
            <View style={styles.View_5Q} pointerEvents={'auto'}>
              <TextField
                onChangeText={newTextAreaUnderlineValue => {
                  const savedFilterDescription = newTextAreaUnderlineValue;
                  try {
