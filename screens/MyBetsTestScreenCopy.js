        ...
        for (let x = 0; x < bets.length; x++) {
          if (Constants.filterLeagueApply.includes(bets[x].event.league)) {
            ...
            exist = primaryLeagues.includes(bets[x].event.league)
              ...
              : true;
            return (
              new Date(bets[x].event.startTime) >= d.setDate(d.getDate() - days)
            );
            if (bets[0].event === null) {
              ...
              return (
                new Date(bets[0].event.startTime) >=
...
return false;
  ...
  return (
    <ScreenContainer style={styles.screen} scrollable={true}>
              ...
              <FlatList
                ...
                renderItem={({ item }) => {
                  ...
                  return (
                    <>
                      <>
                        {!filterBetslipApplied(listData) ? null : (
                          <View pointerEvents={'auto'}>
                            <>
                      ...
                      <>
                        {!filterBetslipApplied(listData?.outcome) ? null : (
                          <View style={styles.ViewN3} pointerEvents={'auto'} />
                        )}
                      </>
                    </>
                  );
                }}
                contentContainerStyle={styles.FlatListbGContent}
                numColumns={1}
              />
            </>
          );
      ...
      >
        <View
          style={[styles.View_1K, { backgroundColor: theme.colors.background }]}
          pointerEvents={'auto'}
        >
          <View pointerEvents={'auto'}>
            <Text style={{ color: theme.colors.error }}>
                  ...
                  {({ loading, error, data, refetchGetBankrollPageById }) => {
                    ...
                    return (
                      <FlatList
                        ...
                        contentContainerStyle={styles.FlatList_53Content}
                        numColumns={1}
                      />
                    );
                  }}
              ...
              <View pointerEvents={'auto'}>
                ...
                <View style={styles.ViewhN} pointerEvents={'auto'}>
                  <Touchable style={styles.TouchableeY}>
                    ...
                    >
                      <Text
                        style={[styles.Texten, { color: theme.colors.strong }]}
                      >
                        {'All'}
                      </Text>
                    </View>
                  ...
                  <Touchable style={styles.TouchablezB}>
                    ...
                    >
                      <Text
                        style={[styles.Text_6z, { color: theme.colors.strong }]}
                      >
                        {'Favorites'}
                      </Text>
                    </View>
                  ...
                  <Touchable style={styles.TouchableLf}>
                    ...
                    >
                      <Text
                        style={[styles.TextXN, { color: theme.colors.strong }]}
                      >
                        {'Underdogs'}
                      </Text>
                    </View>
              ...
              <View pointerEvents={'auto'}>
                ...
                <View style={styles.ViewjF} pointerEvents={'auto'}>
                  <Touchable style={styles.Touchable_3H}>
                    ...
                    >
                      <Text
                        style={[styles.TextSr, { color: theme.colors.strong }]}
                      >
                        {'All'}
                      </Text>
                    </View>
                  ...
                  <Touchable style={styles.Touchabletf}>
                    ...
                    >
                      <Text
                        style={[styles.TextAR, { color: theme.colors.strong }]}
                      >
                        {'Overs'}
                      </Text>
                    </View>
                  ...
                  <Touchable style={styles.TouchablesU}>
                    ...
                    >
                      <Text
                        style={[styles.TextiE, { color: theme.colors.strong }]}
                      >
                        {'Unders'}
                      </Text>
                    </View>
              ...
              <View pointerEvents={'auto'}>
                ...
                <View style={styles.Viewor} pointerEvents={'auto'}>
                  <Touchable style={styles.TouchableZ9}>
                    ...
                    >
                      <Text
                        style={[styles.TextDM, { color: theme.colors.strong }]}
                      >
                        {'All'}
                      </Text>
                    </View>
                  ...
                  <Touchable style={styles.TouchableNq}>
                    ...
                    >
                      <Text
                        style={[styles.TextF2, { color: theme.colors.strong }]}
                      >
                        {'Wins'}
                      </Text>
                    </View>
                  ...
                  <Touchable style={styles.Touchableg1}>
                    ...
                    >
                      <Text
                        style={[styles.TextcJ, { color: theme.colors.strong }]}
                      >
                        {'All'}
                      </Text>
                    </View>
                  ...
                  <Touchable style={styles.Touchableql}>
                    ...
                    >
                      <Text
                        style={[styles.TextYV, { color: theme.colors.strong }]}
                      >
                        {'Pushes'}
                      </Text>
                    </View>
              ...
              <View pointerEvents={'auto'}>
                ...
                <View style={styles.Viewh3} pointerEvents={'auto'}>
                  ...
                  <Touchable style={styles.Touchableb8}>
                    ...
                    >
                      <Text
                        style={[styles.Textqz, { color: theme.colors.strong }]}
                      >
                        {'Bonuses Only'}
                      </Text>
                    </View>
                  ...
                  <Touchable style={styles.Touchabley7}>
                    ...
                    >
                      <Text
                        style={[styles.TextBS, { color: theme.colors.strong }]}
                      >
                        {'No Bonuses'}
                      </Text>
                    </View>
              ...
              <View pointerEvents={'auto'}>
                ...
                <View style={styles.ViewlX} pointerEvents={'auto'}>
                  ...
                  <Touchable style={styles.TouchablebN}>
                    ...
                    >
                      <Text
                        style={[styles.Texty0, { color: theme.colors.strong }]}
                      >
                        {'All'}
                      </Text>
                    </View>
