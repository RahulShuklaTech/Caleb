    ...
    <ScreenContainer scrollable={false} hasSafeArea={false}>
      <View>
        <View style={styles.ViewUq} pointerEvents={'auto'}>
          <Text
            style={[styles.Textyp, { color: theme.colors.background_inverse }]}
          >
                ...
                >
                  ...
                  <View style={styles.Viewvl}>
                    <View style={styles.ViewpV}>
                      ...
                      <Text
                        style={[styles.Text_8D, { color: theme.colors.light }]}
                        ellipsizeMode={'tail'}
                        numberOfLines={1}
                      >
                        {'Risk'}
                      ...
                      <Text
                        style={[styles.TextUN, { color: theme.colors.error }]}
                        ellipsizeMode={'tail'}
                        numberOfLines={1}
                      >
                        {'-$100'}
                      ...
                      <Text
                        style={[styles.Textok, { color: theme.colors.good }]}
                        ellipsizeMode={'tail'}
                        numberOfLines={1}
                      >
                        {'$100'}
                      ...
                      <Text
                        style={[styles.Textox, { color: theme.colors.fair }]}
                        ellipsizeMode={'tail'}
                        numberOfLines={1}
                      >
                        {'-$50'}
                ...
                >
                  ...
                  <View style={styles.View_8g}>
                    <View style={styles.ViewrC}>
                      ...
                      <Text
                        style={[styles.TextEf, { color: theme.colors.light }]}
                        ellipsizeMode={'tail'}
                        numberOfLines={1}
                      >
                        {'Risk'}
                      ...
                      <Text
                        style={[styles.TextYH, { color: theme.colors.error }]}
                        ellipsizeMode={'tail'}
                        numberOfLines={1}
                      >
                        {'-$100'}
                      ...
                      <Text
                        style={[styles.TextaG, { color: theme.colors.good }]}
                        ellipsizeMode={'tail'}
                        numberOfLines={1}
                      >
                        {'$100'}
                      ...
                      <Text
                        style={[styles.Textad, { color: theme.colors.fair }]}
                        ellipsizeMode={'tail'}
                        numberOfLines={1}
                      >
                        {'-$50'}
