    ...
    >
      <View style={[styles.ViewbQ, { borderRadius: 0 }]}>
        <View style={styles.ViewhS} pointerEvents={'auto'}>
          ...
          <View style={[styles.ViewX5, { borderRadius: 0 }]} />
        </View>
      </View>
        ...
        <View style={styles.Viewg7}>
          <View style={styles.View_79}>
            <View style={styles.ViewZG}>
              ...
              <View pointerEvents={'auto'}>
                <>
                  {!verifyLogin(Constants['debugVar']) ? null : (
                    <Text
                      style={[styles.TextP6, { color: theme.colors.error }]}
                    >
                      {Constants['debugVar']}
                    </Text>
                  )}
              ...
              <KeyboardAvoidingView
                style={styles.KeyboardAvoidingViewds}
                enabled={true}
                behavior={'padding'}
              >
                <TextField
                  onChangeText={newTextFieldUnderlineValue => {
                    const userEmail = newTextFieldUnderlineValue;
                    try {
                    ...
                    onPress={async () => {
                      try {
                        ...
                        const loginResult = await SwaggerAPIApi.loginPOST(
                          Constants,
                          { loginIdentity: userEmail, passwrd: textPassword }
                        );
                        setGlobalVariableValue({
                          key: 'loadingLogin',
                          value: false,
            ...
            <View style={styles.Viewh0} pointerEvents={'auto'}>
              <View pointerEvents={'auto'}>
                ...
                <View style={styles.View_3V} pointerEvents={'auto'}>
                  <Touchable>
                    <Text
                      style={[styles.TextEC, { color: theme.colors.light }]}
                    >
              ...
              <View pointerEvents={'auto'}>
                ...
                <View style={styles.ViewO6} pointerEvents={'auto'}>
                  <Touchable>
                    <Text
                      style={[styles.TextMU, { color: theme.colors.light }]}
                    >
                      {'Close'}
                    </Text>
                  </Touchable>
