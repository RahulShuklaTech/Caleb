...
const GamesConfigureBetScreen = props => {
  ...
  return (
    <ScreenContainer scrollable={true} hasSafeArea={false}>
      <Container
        style={{ borderRadius: 0, borderColor: theme.colors.divider }}
          ...
          <View style={styles.ViewwJ} pointerEvents={'auto'}>
            <Touchable>
              <View style={styles.ViewRv}>
                <Icon
                  name={'Ionicons/ios-trash-outline'}
                  size={32}
          ...
          <View style={styles.ViewPd} pointerEvents={'auto'}>
            <Touchable>
              <View style={styles.View_70}>
                <Icon
                  name={'Ionicons/ios-refresh-sharp'}
                  size={32}
        ...
        <View>
            ...
            <KeyboardAvoidingView enabled={true} behavior={'padding'}>
              <View style={styles.ViewWw} pointerEvents={'auto'}>
                <View style={styles.View_2O} pointerEvents={'auto'}>
                  <Picker
                    onValueChange={newPickerUnderlineValue => {
                      const pickerValue = newPickerUnderlineValue;
                      try {
          ...
          <View pointerEvents={'auto'}>
            <KeyboardAvoidingView enabled={true} behavior={'padding'}>
              <View style={styles.Viewhg} pointerEvents={'auto'}>
                <View style={styles.ViewCN} pointerEvents={'auto'}>
                  <TextField
                    onChangeText={newRiskValue => {
                      const textFieldValue = newRiskValue;
                      try {
                    ...
                    placeholder={
                      'Change my fieldname to email or password on the right side'
                    }
                    type={'underline'}
                ...
                <View style={styles.Viewoy} pointerEvents={'auto'}>
                  <TextField
                    onChangeText={newToWinValue => {
                      const textFieldValue = newToWinValue;
                      try {
                        setTextFieldValue(textFieldValue);
                      } catch (err) {
                        console.error(err);
            ...
            <View style={styles.Viewps} pointerEvents={'auto'}>
              <View style={styles.View_7Q} pointerEvents={'auto'}>
                <KeyboardAvoidingView enabled={true} behavior={'padding'}>
                  <TextField
                    onChangeText={newOddsValue => {
                      const textFieldValue = newOddsValue;
                      try {
                        setTextFieldValue(textFieldValue);
                      } catch (err) {
                        console.error(err);
                ...
                <View style={styles.View_46} pointerEvents={'auto'}>
                  <Touchable>
                    <View style={styles.ViewGw} pointerEvents={'auto'}>
                      <Icon
                        name={'Ionicons/ios-remove-circle-outline'}
                        color={theme.colors.light}
                        size={24}
                      />
                    </View>
          ...
          <View pointerEvents={'auto'}>
            <View style={styles.ViewbU} pointerEvents={'auto'}>
              <SwitchRow
                onValueChange={newFactorAllBankrollsValue => {
                  const switchValue = newFactorAllBankrollsValue;
                  try {
                ...
                style={{ color: theme.colors.background_inverse }}
                label={'First Option'}
                value={switchValue}
              />
          ...
          <View pointerEvents={'auto'}>
            <View style={styles.ViewbG} pointerEvents={'auto'}>
              ...
              <View style={styles.ViewS8} pointerEvents={'auto'}>
                <KeyboardAvoidingView
                  style={styles.KeyboardAvoidingViewQ4}
                  enabled={true}
                  behavior={'padding'}
                >
                  <TextField
                    onChangeText={newChanceOfWinningValue => {
                      const textFieldValue = newChanceOfWinningValue;
                      try {
                        setTextFieldValue(textFieldValue);
                      } catch (err) {
                        console.error(err);
          ...
          <View style={styles.View_3F} pointerEvents={'auto'}>
            ...
            <Slider
              ...
              value={sliderValue}
            />
            <Divider style={styles.Divider_0P} color={theme.colors.divider} />
          </View>
        </View>
        ...
        <View>
          <View>
            ...
            <View style={styles.ViewKI} pointerEvents={'auto'}>
              <KeyboardAvoidingView
                style={styles.KeyboardAvoidingViewku}
                enabled={true}
                behavior={'padding'}
              >
                <TextField
                  onChangeText={newTextFieldUnderlineValue => {
                    const textFieldValue = newTextFieldUnderlineValue;
                    try {
                      setTextFieldValue(textFieldValue);
                    } catch (err) {
                      console.error(err);
            ...
            <View style={styles.ViewYL} pointerEvents={'auto'}>
              <KeyboardAvoidingView
                style={styles.KeyboardAvoidingViewpY}
                enabled={true}
                behavior={'padding'}
              >
                <TextField
                  onChangeText={newTextAreaUnderlineValue => {
                    const textFieldValue = newTextAreaUnderlineValue;
                    try {
                      setTextFieldValue(textFieldValue);
                    } catch (err) {
                      console.error(err);
